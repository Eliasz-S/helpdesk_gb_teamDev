...
/* harmony import */ var _lang__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_lang__WEBPACK_IMPORTED_MODULE_3__);
// require('./bootstrap');
...
var app = new vue__WEBPACK_IMPORTED_MODULE_4__["default"]({
  ...
  // компонент, кот. рендерится в начальный момент времени
...
var routes = __webpack_require__(/*! ./routes */ "./resources/js/routes.json"); ///route('home', ['1'])
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    path: '/wl',
    component: _components_User__WEBPACK_IMPORTED_MODULE_0__["default"]
  }],
...
"use strict";
module.exports = JSON.parse('{"":"password/confirm","users.index":"api/users","users.create":"api/users/create","users.store":"api/users","users.show":"api/users/{user}","users.edit":"api/users/{user}/edit","users.update":"api/users/{user}","users.destroy":"api/users/{user}","login":"login","logout":"logout","register":"register","password.request":"password/reset","password.email":"password/email","password.reset":"password/reset/{token}","password.update":"password/reset","password.confirm":"password/confirm","customer":"customer","home":"home"}');
